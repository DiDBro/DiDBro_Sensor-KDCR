...
m1 = 35;m2 = 25;m3 = 18;m4 = 7; % 【kg】

% link 1
Ix1 = m1*l1^2/12; %[given formula to calculate]
Iz1 = Ix1;%[given formula to calculate]
Iy1 = 0.05*Ix1;%[given formula to calculate]
...
Iz3 = 0.1*Iz2;Ix3 = 0.2*Iz3;Iy3 = 0.2*Iz3;

Iz4 = 0.6*Iz3;Ix4 = 0.2*Iz4;Iy4 = 0.2*Iz4;

% as in Eq (4.9) p. 162
calM1 = [m1*eye(3) zeros(3);zeros(3) diag([Ix1 Iy1 Iz1])]; % Spatial inertia 矩阵
